...
const effectComponentMap: EffectComponentMap = {
  ...
  'scroll-progress': () => import('./effects/ScrollProgress'),
  ...
  'form-float-label': () => import('./effects/ImplForm'),
  'form-focus-border': () => import('./effects/ImplForm'),
  'form-shake-error': () => import('./effects/ImplForm'),
  'form-success-check': () => import('./effects/ImplForm'),
  'form-password-reveal': () => import('./effects/ImplForm'),
  'form-search-expand': () => import('./effects/ImplForm'),
  'form-radio-custom': () => import('./effects/ImplForm'),
  'form-checkbox-custom': () => import('./effects/ImplForm'),
  'form-switch-ios': () => import('./effects/ImplForm'),
  'form-range-slider': () => import('./effects/ImplForm'),
  'loader-circle': () => import('./effects/ImplLoader'),
  'loader-bar': () => import('./effects/ImplLoader'),
  'loader-dots': () => import('./effects/ImplLoader'),
  'loader-text': () => import('./effects/ImplLoader'),
  'loader-glitch': () => import('./effects/ImplLoader'),
  'loader-svg': () => import('./effects/ImplLoader'),
  'loader-mask': () => import('./effects/ImplLoader'),
